      ...
      <div className="absolute bottom-32 sm:bottom-40 left-0 right-0 z-10">
        <div className="container">
          <a
            ...
            className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 hover:bg-white/15 transition-colors"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 sm:w-4.5 sm:h-4.5 flex-shrink-0">
            ...
            <span className="text-white/60 text-xs">108 reviews</span>
          </a>
        </div>
      </div>
