        ...
        <div className="container max-w-3xl py-16 lg:py-24">
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-[#32302F]/80 leading-relaxed">
            ...
            <section>
              ...
              <p className="text-[#345460]/70 leading-relaxed mb-4">When you opt in on our inquiry form, we store campaign information and advertising click identifiers with your inquiry to connect it to resulting bookings and measure advertising results. This choice is optional and does not affect your ability to contact or book with us. We retain contact details to respond to your inquiry. Payment cards and booking account credentials remain in Gingr; they are not part of this attribution record. Contact us to request deletion of your inquiry and attribution data. This website feature does not automatically upload your inquiry or booking information to advertising platforms.</p>
